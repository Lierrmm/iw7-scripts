f0_local1 = nil
f0_local0 = "frontEnd.systemLinkMenu.serverBrowser"
SystemLinkMenuType = function ( f1_arg0, f1_arg1 )
	return f0_local1( f1_arg0, f1_arg1 )
end

MenuBuilder.registerType( "MPSystemLinkMenu", SystemLinkMenuType )
MenuBuilder.registerType( "CPSystemLinkMenu", SystemLinkMenuType )
...
LUI.FlowManager.RegisterStackPushBehaviour( "MPSystemLinkMenu", function ()
	...
	utils.mp.FenceOnlineData.FenceOnlineData.OnBackOut()
end )
		...
		f11_arg0.bindButton:addEventHandler( "button_secondary", function ( f14_arg0, f14_arg1 )
			...
			if f14_local0.serverBrowserFocused then
				...
				if CONDITIONS.IsThirdGameMode( f11_arg0 ) then
					ACTIONS.AnimateSequence( f11_arg0, "HideServerBrowser" )
...
MenuBuilder.registerType( "SystemLinkMenu", function ( menu, controller )
	...
	if CONDITIONS.IsThirdGameMode( self ) then
		...
		f22_local13:setText( Engine.Localize( "PLATFORM_SYSTEM_LINK_CAPS" ), 0 )
	...
	if CONDITIONS.IsThirdGameMode( self ) then
		...
		f22_local14:setText( Engine.Localize( "PLATFORM_SYSTEM_LINK_CAPS" ), 0 )
